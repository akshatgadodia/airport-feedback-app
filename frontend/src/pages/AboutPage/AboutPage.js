  ...
  return(
    <div className="about">
        <div className="about-content">
          ...
          <p>
            AAI airports collect feedback forms as part of customer
            satisfaction, grievance feedback mechanism. Project is to collect
            the data electronically in the form of an APP with selectable
            parameters and rating . The APP will be available by default on the
            free WIFI service that AAI is going to provide at Airports.
          </p>
        </div>
        <div className="about-developed">
          ...
          <div className="about-contact-information">
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <InstagramIcon fontSize="medium" style={{ color: "black" }} />{" "}
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <FacebookIcon fontSize="medium" style={{ color: "black" }} />
            </a>
